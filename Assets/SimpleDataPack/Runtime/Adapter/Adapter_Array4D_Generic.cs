...
public partial class SimpleDataPack
{
	...
	/// </summary>
	/// <typeparam name="T"></typeparam>
	public class Array4DGenericVersatileAdapter : IAdapter
	{
		...
		public Array4DGenericVersatileAdapter( Type objectType, Type elementType )
		{
			...
			for( index_0  = 0 ; index_0 <  length_0 ; index_0 ++ )
			{
				for( index_1  = 0 ; index_1 <  length_1 ; index_1 ++ )
				{
					for( index_2  = 0 ; index_2 <  length_2 ; index_2 ++ )
					{
						for( index_3  = 0 ; index_3 <  length_3 ; index_3 ++ )
						{
							serialize( elements.GetValue( index_0, index_1, index_2, index_3 ), writer ) ;
						}
					}
				}
			}
		...
		public System.Object Deserialize( ByteStream reader )
		{
			...
			{
				// 基本的にはありえない
				return Array.CreateInstance( m_ElementType, length_0, length_1, length_2, length_3 ) ;
			}

			var elements = Array.CreateInstance( m_ElementType, length_0, length_1, length_2, length_3 ) ;
			...
			for( index_0  = 0 ; index_0 <  length_0 ; index_0 ++ )
			{
				for( index_1  = 0 ; index_1 <  length_1 ; index_1 ++ )
				{
					for( index_2  = 0 ; index_2 <  length_2 ; index_2 ++ )
					{
						for( index_3  = 0 ; index_3 <  length_3 ; index_3 ++ )
						{
							elements.SetValue( deserialize( reader ), index_0, index_1, index_2, index_3 ) ;
						}
					}
				}
			}
