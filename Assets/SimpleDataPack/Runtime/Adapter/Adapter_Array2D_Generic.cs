...
public partial class SimpleDataPack
{
	...
	/// </summary>
	/// <typeparam name="T"></typeparam>
	public class Array2DGenericVersatileAdapter : IAdapter
	{
		...
		public Array2DGenericVersatileAdapter( Type objectType, Type elementType )
		{
		...
		public void Serialize( System.Object entity, ByteStream writer )
		{
			...
			for( index_0  = 0 ; index_0 <  length_0 ; index_0 ++ )
			{
				for( index_1  = 0 ; index_1 <  length_1 ; index_1 ++ )
				{
					serialize( elements.GetValue( index_0, index_1 ), writer ) ;
				}
			}
		}
		...
		public System.Object Deserialize( ByteStream reader )
		{
			...
			{
				// 基本的にはありえない
				return Array.CreateInstance( m_ElementType, length_0, length_1 ) ;
			}

			var elements = Array.CreateInstance( m_ElementType, length_0, length_1 ) ;
			...
			for( index_0  = 0 ; index_0 <  length_0 ; index_0 ++ )
			{
				for( index_1  = 0 ; index_1 <  length_1 ; index_1 ++ )
				{
					elements.SetValue( deserialize( reader ), index_0, index_1 ) ;
				}
			}
