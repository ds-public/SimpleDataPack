...
namespace DSW.MyData
{
	public partial class MyObject_W
	{
		public void Serialize__SimpleDataPack( SimpleDataPack.ByteStream writer )
		{
			...
			if( P33 == null ){ writer.PutByte( 0 ) ; }else{ writer.PutInt32T( ( Int32 )P33 ) ; }
		...
		public void Deserialize__SimpleDataPack( SimpleDataPack.ByteStream reader )
		{
			...
			P16 = ( DSW.MyData.Status_W )Enum.ToObject( typeof( DSW.MyData.Status_W ), reader.GetInt32() ) ; 
			...
			{ var _ = reader.GetInt32N() ; P33 = _ == null ? null : ( DSW.MyData.Status_W? )Enum.ToObject( typeof( DSW.MyData.Status_W ), ( Int32 )_ ) ; }
	...
	public partial class MySampleSub_W
	{
		public void Serialize__SimpleDataPack( SimpleDataPack.ByteStream writer )
		{
			writer.PutByte( STR ) ;
			writer.PutByte( INT ) ;
			if( Special == null ){ writer.PutByte( 0 ) ; }else{ writer.PutInt32T( ( Int32 )Special ) ; }
		...
		public void Deserialize__SimpleDataPack( SimpleDataPack.ByteStream reader )
		{
			STR = reader.GetByte() ;
			INT = reader.GetByte() ;
			{ var _ = reader.GetInt32N() ; Special = _ == null ? null : ( DSW.MyData.Status_W? )Enum.ToObject( typeof( DSW.MyData.Status_W ), ( Int32 )_ ) ; }
	...
	public partial class MyInterface_Type0
	{
		public void Serialize__SimpleDataPack( SimpleDataPack.ByteStream writer )
		{
			writer.PutInt32( TypeCode ) ;
		}
		public void Deserialize__SimpleDataPack( SimpleDataPack.ByteStream reader )
		{
			TypeCode = reader.GetInt32() ;
		}
	}

	public partial class MyInterface_Type1
	{
		public void Serialize__SimpleDataPack( SimpleDataPack.ByteStream writer )
		{
			writer.PutInt32( TypeCode ) ;
	...
	public partial class MyInterface_Type2
	{
		public void Serialize__SimpleDataPack( SimpleDataPack.ByteStream writer )
		{
			writer.PutInt32( TypeCode ) ;
